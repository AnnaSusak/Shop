...
namespace ShopM4_DataMigrations
{
    ...
    [Migration("20230402173022_AddColumsToOrderHeaderTable")]
    partial class AddColumsToOrderHeaderTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopM4_Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopM4_Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopM4_Models.QueryDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopM4_Models.QueryHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopM4_Models.OrderDetail", b =>
                {
                    b.HasOne("ShopM4_Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ShopM4_Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ShopM4_Models.OrderHeader", b =>
                {
                    b.HasOne("ShopM4_Models.ApplicationUser", "Admin")
                        .WithMany()
            ...
            modelBuilder.Entity("ShopM4_Models.QueryDetail", b =>
                {
                    ...
                    b.HasOne("ShopM4_Models.QueryHeader", "QueryHeader")
                        .WithMany()
            ...
            modelBuilder.Entity("ShopM4_Models.QueryHeader", b =>
                {
                    b.HasOne("ShopM4_Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
